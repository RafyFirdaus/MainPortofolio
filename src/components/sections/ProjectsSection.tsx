    ...
    <section className="max-w-6xl mx-auto py-20" id="projects">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <MagicCard className="group flex flex-col bg-white dark:bg-surface-dark overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1" gradientColor="rgba(19, 127, 236, 0.1)">
          <div className="h-48 overflow-hidden bg-slate-50 dark:bg-slate-800 relative">
            <Image
              src="/images/projects/WhatsApp Image 2026-07-11 at 21.18.58.jpeg"
              alt="AI WhatsApp Healthcare CRM & Chatbot System"
              fill
              className="object-contain transition-transform duration-500 group-hover:scale-105"
            />
          </div>
          <div className="p-6 flex flex-col grow">
            <div className="mb-4">
              <h3 className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors">{t.projects.waHealthcareCrm.title}</h3>
              <p className="text-sm text-slate-500 mt-1 dark:text-slate-400">{t.projects.waHealthcareCrm.tagline}</p>
            </div>
            <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed mb-6 line-clamp-3">
              {t.projects.waHealthcareCrm.desc}
            </p>
            <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
              <div className="flex gap-2 flex-wrap">
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded">FASTAPI</span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded">RASA & GROQ</span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-slate-400 bg-slate-50 dark:bg-slate-800 px-2 py-1 rounded">SUPABASE</span>
              </div>
              <Link href="/projects/wa-healthcare-crm">
                <span className="material-symbols-outlined text-slate-400 hover:text-primary cursor-pointer text-xl">arrow_outward</span>
              </Link>
            </div>
          </div>
