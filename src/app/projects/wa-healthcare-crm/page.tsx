...
export default function WaHealthcareCrmProject() {
      ...
      <main className="grow w-full max-w-[1200px] mx-auto px-6 py-12 md:py-20 flex flex-col gap-16">
        ...
        <section className="flex flex-col items-center text-center gap-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 mt-4">
            ...
            <Badge variant="secondary">Rasa Open Source</Badge>
            <Badge variant="secondary">Groq LLM</Badge>
            <Badge variant="secondary">Supabase (PostgreSQL)</Badge>
            <Badge variant="secondary">SmartClinic API</Badge>
            <Badge variant="secondary">Fonnte WA Gateway</Badge>
          </div>
        </section>
        ...
        <section className="w-full relative group cursor-pointer">
          <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-xl shadow-slate-200/50 dark:shadow-black/50 border border-slate-200 dark:border-slate-800">
            <iframe
              src="https://res.cloudinary.com/dhsmcxmeo/video/upload/v1786528381/Untitled_Project_tqaktk.mp4"
              className="absolute inset-0 w-full h-full"
              allow="autoplay; fullscreen; encrypted-media; picture-in-picture"
              allowFullScreen
              frameBorder="0"
              title="AI WhatsApp Healthcare CRM Video Demo"
            ></iframe>
          ...
          <div className="lg:col-span-7 flex flex-col gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed text-lg">
                <p>
                  <strong className="text-slate-900 dark:text-white">{t.projectDetails.theProblem}</strong> {t.projectDetails.waHealthcareCrm.problemText}
                </p>
                <p>
                  <strong className="text-slate-900 dark:text-white">{t.projectDetails.theSolution}</strong> {t.projectDetails.waHealthcareCrm.solutionText}
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <MagicCard className="flex flex-col p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow" gradientColor="rgba(19, 127, 236, 0.1)">
                  ...
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">{t.projectDetails.waHealthcareCrm.feature1Title}</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">{t.projectDetails.waHealthcareCrm.feature1Desc}</p>
                </MagicCard>
                <MagicCard className="flex flex-col p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow" gradientColor="rgba(19, 127, 236, 0.1)">
                  <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                    <span className="material-symbols-outlined">event_available</span>
                  </div>
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">{t.projectDetails.waHealthcareCrm.feature2Title}</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">{t.projectDetails.waHealthcareCrm.feature2Desc}</p>
                </MagicCard>
                <MagicCard className="flex flex-col p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow" gradientColor="rgba(19, 127, 236, 0.1)">
                  <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                    <span className="material-symbols-outlined">support_agent</span>
                  </div>
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">{t.projectDetails.waHealthcareCrm.feature3Title}</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">{t.projectDetails.waHealthcareCrm.feature3Desc}</p>
                </MagicCard>
                <MagicCard className="flex flex-col p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow" gradientColor="rgba(19, 127, 236, 0.1)">
                  <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                    <span className="material-symbols-outlined">shield</span>
                  </div>
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">{t.projectDetails.waHealthcareCrm.feature4Title}</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">{t.projectDetails.waHealthcareCrm.feature4Desc}</p>
                </MagicCard>
                <MagicCard className="flex flex-col p-5 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 shadow-sm hover:shadow-md transition-shadow sm:col-span-2" gradientColor="rgba(19, 127, 236, 0.1)">
                  <div className="size-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary mb-4">
                    <span className="material-symbols-outlined">database</span>
                  </div>
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">{t.projectDetails.waHealthcareCrm.feature5Title}</h4>
                  <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">{t.projectDetails.waHealthcareCrm.feature5Desc}</p>
                </MagicCard>
              </div>
            </div>
          </div>
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-6 md:p-8 border border-slate-200 dark:border-slate-700 relative overflow-hidden">
              ...
              <div className="space-y-6 relative">
                ...
                <div className="relative pl-8">
                  ...
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">{t.projectDetails.waHealthcareCrm.tech1Title}</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    {t.projectDetails.waHealthcareCrm.tech1Desc}
                  </p>
                </div>
                {/* Item 2 */}
                <div className="relative pl-8">
                  <div className="absolute left-0 top-1 size-6 bg-white dark:bg-slate-800 border-2 border-primary rounded-full z-10" />
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">{t.projectDetails.waHealthcareCrm.tech2Title}</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    {t.projectDetails.waHealthcareCrm.tech2Desc}
                  </p>
                </div>
                {/* Item 3 */}
                <div className="relative pl-8">
                  <div className="absolute left-0 top-1 size-6 bg-white dark:bg-slate-800 border-2 border-primary rounded-full z-10" />
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">{t.projectDetails.waHealthcareCrm.tech3Title}</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    {t.projectDetails.waHealthcareCrm.tech3Desc}
                  </p>
                </div>
                {/* Item 4 */}
                <div className="relative pl-8">
                  <div className="absolute left-0 top-1 size-6 bg-white dark:bg-slate-800 border-2 border-primary rounded-full z-10" />
                  <h4 className="text-sm font-bold text-slate-900 dark:text-white mb-1">{t.projectDetails.waHealthcareCrm.tech4Title}</h4>
                  <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                    {t.projectDetails.waHealthcareCrm.tech4Desc}
                  </p>
                </div>
              </div>
            </div>
